...
if __name__ == "__main__":
    ...
    parser.add_argument('--defense_method', type=str, default="no-defense",
                        help='defense method used: no-defense|norm-clipping|norm-clipping-adaptive|weak-dp|multi-metrics|krum|multi-krum|rfa|scope')
    ...
    parser.add_argument('--attack_method', type=str, default="blackbox",
                        help='describe the attack type: blackbox|pgd|graybox|constrained_and_scale|cosine_constrained')
